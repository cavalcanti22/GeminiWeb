...
<head>
  <meta charset="UTF-8">
  <title>Gemini Web Floripa</title>
...
#bg {
  ...
  width: 100%;
  height: 100%;
  background: url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRkKcltH7IdJ0eLC013Fn1-Xb_b0m6j4-vG_yEQ2rqwD8UA82gF) no-repeat center center fixed;
